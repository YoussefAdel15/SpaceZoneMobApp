...
const SharedAreaPage = ({ route, navigation }) => {
  ...
  const sharedAreaPrice = place.hourPrice;
  ...
  const RoomPhotos = place.sharedAreaPhotos;
  ...
  const handleCheckAvailability = () => {
    ...
    if (startHour && endHour && date) {
      ...
      axios
        .post(
          `https://spacezone-backend.cyclic.app/api/booking/checkAvailability/${placeID}`,
          {
            Date: selectedDate,
            startTime: startHour,
            endTime: endHour,
    ...
    <ScrollView>
      ...
      <View style={styles.container}>
        <TouchableOpacity style={styles.roomDet}>
          ...
          {/* Room details */}
          <Text>Room Name: {place.placeName} Shared Area</Text>
          <Text>Capacity: {numberOfSeats}</Text>
          <Text>Price: {sharedAreaPrice} EGP</Text>
        </TouchableOpacity>

        {/* Number of seats input form */}
        ...
        <TouchableOpacity style={styles.btnContainer}>
          ...
          <TouchableOpacity
            style={styles.btnBook}
            onPress={() =>
              navigation.navigate("SharedBooking", {
                place: place,
              })
            }
          >
